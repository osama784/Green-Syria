        ...
        <>
            <div className="w-full bg-green-200 pt-16 pb-28 px-10 sm:px-16 lg:px-40">
                <header className="flex justify-center sm:justify-between items-center gap-x-28 gap-y-5 flex-wrap">
                    <div className="flex justify-center items-center gap-3">
                        ...
                        <h2 className="sm:text-2xl font-semibold rounded-lg bg-white p-3">Green Syria</h2>
                    </div>
                    <button className="bg-white rounded-3xl size-fit px-3 py-2 hover:bg-green-300 transition-colors">Contact us</button>
                </header>
                <div className="flex gap-5 justify-center items-center mt-20 sm:mt-24 xl:px-56">
                    <div className="text-right">
                        <p className="font-bold text-2xl sm:text-5xl">ساهم في سوريا الخضراء </p>

                        <p className="text-xl sm:text-3xl mt-4">دعنا نجعل بيئتك نظيفة</p>

                        <p className="mt-5 text-lg sm:text-xl">
                            إذا كنت ترغب في استجابة سريعة وفعالة من الجهات المسؤولة، نقدم لك منصة إلكترونية، أداتك الموثوقة للإبلاغ عن
                            الحاويات الممتلئة أو المناطق المتسخة. من خلالها يمكنك متابعة بلاغاتك بسهولة والحصول على تحديثات فورية عن حالتها،
                            مع ربطها مباشرة بالجهات المسؤولة من بلديات أو شركات خاصة
                        </p>
            ...
            <div className="w-full pt-16 pb-28 px-10 sm:px-16 xl:px-96 text-right flex gap-20 flex-col">
                <div>
                    <h2 className="text-xl sm:text-3xl">
                        شريكك في بيئة <span className="font-semibold bg-green-200 p-1">نظيفة</span>
                    </h2>
                    <p className="mt-4 text-lg">
                        في شركة جرين سيريا،نمكنك من إرسال الشكاوي إلى الجهات المعنية. سواء كنت تبحث عن مناطق غير نظيفة أو وجدت حاويات
                        ممتلئة، فإن برنامجنا مصمم مع وضع أهدافك في الاعتبار
                    </p>
                    <ul className="justify-self-center flex flex-col gap-8 mt-16 sm:text-lg">
                        <li className="flex gap-3 items-center justify-end">
                            ...
                            <div className="space-y-1 -order-1">
                                ...
                                <p>النفايات أصبحت مشكلة كبيرة تهدد كوكبنا، لكن كل واحد منا يستطيع أن يكون جزءًا من الحل!</p>
                            </div>
                        </li>
                        <li className="flex gap-3 items-center justify-end">
                            ...
                            <div className="space-y-1 -order-1">
                                ...
                                <p>تقليل النفايات يعني تقليل القمامة في مكبات النفايات، مما يحافظ على التربة والمياه من التلوث</p>
                            </div>
                        </li>
                        <li className="flex gap-3 items-center justify-end">
                            ...
                            <div className="space-y-1 -order-1">
                                ...
                                <p>إعادة استخدام الأشياء بدلاً من رميها يقلل الحاجة لاستخراج مواد خام جديدة مثل الأخشاب أو البترول</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div className="flex gap-3 bg-green-200 text-left justify-self-center self-center p-7 rounded-lg">
                    <Image src={digitalFoundry} alt="image" className="size-12" data-src-desktop-1x={digitalFoundry} />
              ...
              reflection of what we are doing to ourselves and to one another.
                        ...
                        <p className="text-right">إن ما نفعله بغابات العالم ما هو إلا انعكاس لما نفعله بأنفسنا وببعضنا البعض.</p>
            ...
            <div className="flex flex-col gap-10 bg-gray-200 pt-16 pb-28 px-10 sm:px-16 xl:px-72">
                <h1 className="text-xl sm:text-2xl md:text-4xl self-center text-center">
                    برامج <span className="font-bold">مصممة للنجاح</span> في بيئة نظيفة
                </h1>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                    <div className="flex flex-col items-center justify-center text-center gap-3 rounded-xl bg-white p-5">
                        ...
                        />
                        <div>
                            <h2 className="font-bold mb-1 text-lg">رؤيتنا</h2>
                            <p>
                                خلق بيئة نظيفة ومستدامة من خلال تمكين المجتمعات بأدوات ذكية لإدارة النفايات بكفاءة، وتعزيز الوعي البيئي
                                والتعاون بين الأفراد والجهات المسؤولة
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-center text-center gap-3 rounded-xl bg-white p-5">
                        ...
                        <div>
                            <h2 className="font-bold mb-1 text-lg">هدفنا</h2>
                            <p>
                                نسعى لتطوير تطبيق مبتكر يسهل على المستخدمين جدولة جمع النفايات، الإبلاغ عن المشكلات البيئية، وتلقي التنبيهات
                                والنصائح لتقليل النفايات وإعادة التدوير.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-center text-center gap-3 rounded-xl bg-white p-5">
                        ...
                        />
                        <div>
                            <h2 className="font-bold mb-1 text-lg">التعاون مع المنظمات الحكومية</h2>
                            <p>
                                نهدف إلى تحسين كفاءة إدارة النفايات بالتعاون مع الجهات الحكومية، لضمان استجابة سريعة وفعالة، وبناء مجتمع
                                أكثر نظافة ووعيًا
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center gap-3 rounded-xl bg-white p-5">
                        ...
                        />
                        <div>
                            <h2 className="font-bold mb-1 text-lg">تحليلات</h2>
                            <p>إجراء إحصائيات مع عدد كبير من الأشخاص باستخدام النماذج ومشاركتها مع الآخرين</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full pt-24 pb-28 px-10 sm:px-16 xl:px-60">
                <div className="content-center text-center mb-10 space-y-2">
                    <h1 className="text-2xl sm:text-3xl md:text-5xl text-green-500">كيف يعمل التطبيق؟</h1>
                    <p className="text-gray-400">ماذا يحدث بعد الإبلاغ عن مكب نفايات غير قانوني؟</p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div className="flex flex-col items-center justify-center gap-5 shadow-xl px-8 py-8 text-center border">
                        ...
                        >
                            <g id="1903985155">
                                <path d="M27,16h4c0.6,0,1-0.4,1-1s-0.4-1-1-1h-4c-0.6,0-1,0.4-1,1S26.4,16,27,16z" id="1041326793"></path>
                                <path d="M31,54h-4c-0.6,0-1,0.4-1,1s0.4,1,1,1h4c0.6,0,1-0.4,1-1S31.6,54,31,54z" id="1256229200"></path>
                                <path
                        ...
                        <h2 className="font-bold text-green-500 text-xl sm:text-3xl">1. الإبلاغ عن مكب غير قانوني</h2>
                        <p>لقد عثرت على مكب نفايات غير قانوني، والتقطت صورة وأبلغت عنها باستخدام تطبيق الجوال</p>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-5 shadow-xl px-8 py-8 text-center border bg-green-50">
                        ...
                        c0,0.6-0.4,1-1,1H40l-5,6.7L30,48H13c-0.6,0-1-0.4-1-1V15c0-0.6,0.4-1,1-1h44c0.6,0,1,0.4,1,1V47z"
                                    id="1435376203"
                                ></path>
                                <rect x="20" y="38" width="30" height="2" id="1645529775"></rect>
                                <rect x="20" y="30" width="30" height="2" id="1917386756"></rect>
                                <rect x="20" y="22" width="30" height="2" id="1604276218"></rect>
                            </g>
                        </svg>
                        <h2 className="font-bold text-green-500 text-xl sm:text-3xl">2. تنبيه الأشخاص المهتمين</h2>
                        <p>سيتم إخطار المنظمات البيئية والبلديات والأفراد المهتمين الذين اشتركوا في تلقي الإشعارات عبر البريد الإلكتروني</p>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-5 shadow-xl px-8 py-8 text-center border bg-green-300">
                        ...
                        <h2 className="font-bold text-green-500 text-xl sm:text-3xl">3. تنظيم عملية التنظيف</h2>
                        <p>تنظم منظمة بيئية أو بلدية أو ناشط محلي حدث تنظيف. يمكنك حتى المشاركة</p>
                    </div>
                    <div className="flex flex-col items-center justify-center gap-5 shadow-xl px-8 py-8 text-center border bg-green-500 text-white">
                        ...
                        s23-10.3,23-23S47.7,12,35,12z"
                                    id="1278041624"
                                ></path>
                                <polygon points="32,43.4 23.3,34.7 24.7,33.3 32,40.6 48.3,24.3 49.7,25.7 	" id="1468397409"></polygon>
                            </g>
                        </svg>
                        <h2 className="font-bold text-xl sm:text-3xl">4.يتم تنظيف الموقع بالكامل</h2>
                        <p>بعد الحدث، سيتم إعلامك بأن مكب النفايات الذي أبلغت عنه قد تم تنظيفه. انتقل إلى الحدث التالي</p>
                    </div>
                </div>
            </div>
            <div className="w-full pt-16 pb-28 px-10 sm:px-16 xl:px-72">
                <div className="grid grid-cols-12 grid-rows-12 max-h-[600px] gap-5">
                    <Image src={trash4} alt="image" className="hidden sm:block col-span-6 row-span-full size-full shadow-lg border" />
                    <Image src={trash2} alt="image" className="col-span-full sm:col-span-6 row-span-6 size-full shadow-lg border" />
                    <Image src={trash1} alt="image" className="col-span-full sm:col-span-6 row-span-6 size-full shadow-lg border" />
                </div>
            </div>
            <footer className="bg-white shadow flex items-center justify-center border-t p-4 sm:p-6 xl:p-8 ">
                <p className="mb-4 text-sm text-center sm:mb-0 w-fit ">&copy; 2025 Green Syria. All rights reserved.</p>
            </footer>
        </>
    );
}
